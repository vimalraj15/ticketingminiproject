...
<form name="myForm" action="/verify"  onsubmit="return validateForm()">
	...
	<h3> ${mural}${SPRING_SECURITY_LAST_EXCEPTION.message}</h3>
	<h1>Create Account</h1>
	<span>or use your email for registration</span>
	<input type="mailid" name="mailid" placeholder="Email" value ="${murali}" required>
...
<div class="form-container sign-in-container">
	...
	<span> use gmail account for signin</span>
	<input type="mailid" name="mailid" placeholder="Email" required>
